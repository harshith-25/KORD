...
import conversationRoutes from "./routes/converseRoutes.js";
...
app.use(
  cors({
    origin: [process.env.CORS_ORIGIN, "http://localhost:5173", "http://localhost:3000", "https://kord-ciix.onrender.com"],            // allow only your frontend

...
// Import Lucide icons
import { Eye, EyeOff, Mail, Lock, Sparkles, ArrowRight, User, Zap } from 'lucide-react'; // Added User icon for names
...
const RegisterPage = () => {
	...
	// Get register function and loading/error state from your authStore
	const { register, loading, error: authError, setLoading, setError } = useAuthStore();
	...
	const handleSubmit = async (e) => {
		...
		try {
			await register(firstName, lastName, email, password); // Ensure authStore accepts these
	...
	return (
		<div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
			...
			<div className="relative group">
				...
				{/* Main card */}
				<div className="relative bg-white rounded-xl shadow-2xl p-4 w-80 transform transition-all duration-300 hover:scale-105">
					{/* Glowing top accent */}
					...
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<div className="relative">
							<div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-all duration-300 ${firstName ? 'text-purple-500' : 'text-gray-400'}`}>
							...
							<input
								...
								className="w-full pl-10 pr-4 py-2.5 border-2 border-gray-200 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-purple-500 transition-all duration-300 hover:border-purple-300"
						...
						{/* Last Name Input */}
						<div className="relative">
							<div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-all duration-300 ${lastName ? 'text-purple-500' : 'text-gray-400'}`}>
								<User className="h-4 w-4" />
							</div>
							<input
								type="text"
						...
						<div className="relative">
							...
							<input
								...
								className="w-full pl-10 pr-12 py-2.5 border-2 border-gray-200 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-purple-500 transition-all duration-300 hover:border-purple-300"
